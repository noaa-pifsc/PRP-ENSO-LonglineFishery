...
tname_obs_bait <- paste(tolower(shma_obs), table_obs$TABLE_NAME[49], sep = '.') # LOP_EXPR_TRIP_TYPE
tname_obs_exprtype <- paste(tolower(shma_obs), table_obs$TABLE_NAME[19], sep = '.') # LOP_BAIT
