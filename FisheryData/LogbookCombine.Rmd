...
setnames(DeepSets, c(13:56), paste(rep(c('BLUEMARLIN', 'STRIPEDMARLIN', 'BLACKMARLIN',
...
saveRDS(object = DeepSets, file = here("FisheryData", "DeepSets_PMUS.rds"))
write_csv(DeepSets, file = here("FisheryData", "DeepSets_PMUS.csv"))
```
