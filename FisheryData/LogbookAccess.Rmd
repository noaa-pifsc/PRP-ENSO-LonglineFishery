...
saveRDS(object = logbookHDR, file = here("FisheryData", "LogbookHDR_allFields.rds"))
...
# Save dataset (the internet appears to unanimously agree that rds is superior to csv in terms of speed, memory, metadata preservation, and more)
saveRDS(object = logbookDETAIL, file = here("FisheryData", "LogbookDETAIL_allFields.rds"))
